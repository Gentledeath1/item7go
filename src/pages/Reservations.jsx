    ...
    <div className="bg-brand-cream min-h-screen">
      ...
      <div className="bg-brand-dark pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
          ...
          >
            Whether it is an intimate dinner, a birthday celebration, or a full
            corporate catering request, we have a package that fits. Book your
            table or enquire about our event services below.
          </motion.p>
        </div>
      </div>
