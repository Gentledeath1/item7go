...
export default function Home() {
  return (
    <>
      <SEO
        title="Fast Casual Dining in Ibadan"
        description="Item 7 Go serves the best shawarma, jollof rice, burgers and fries on Iwo Road, Ibadan. Fast service, honest prices, great food every time."
        canonical="/"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "Restaurant",
          name: "Item 7 Go",
          image: "https://item7go-rho.vercel.app/images/hero-bg.jpg",
          url: "https://item7go-rho.vercel.app",
          ...
          servesCuisine: ["Nigerian", "Fast Food", "Shawarma", "Burgers"],
