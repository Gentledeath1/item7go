...
export default function Menu() {
  ...
  return (
    <>
      <SEO
        title="Our Menu"
        description="Explore the full Item 7 Go menu — shawarma, jollof rice, smash burgers, seasoned fries, drinks and more. Fresh, fast, and affordable in Ibadan."
        canonical="/menu"
        structuredData={{
          ...
          name: "Item 7 Go Menu",
          description:
            "Full food and drinks menu for Item 7 Go, Iwo Road Ibadan.",
          url: "https://item7go-rho.vercel.app/menu",
          inLanguage: "en",
        }}
      />
