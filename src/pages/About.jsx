...
export default function About() {
  return (
    <>
      <SEO
        title="About Us"
        description="Learn the story behind Item 7 Go — Ibadan's fast casual dining brand built on quality, speed, and consistency. Located on Iwo Road since 2019."
        canonical="/about"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "AboutPage",
          name: "About Item 7 Go",
          description: "The story, values, and team behind Item 7 Go, Ibadan.",
          url: "https://item7go-rho.vercel.app/about",
        }}
      />
      <div className="bg-brand-cream min-h-screen">
        ...
        <div className="bg-brand-dark pt-40 pb-20 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
            ...
            >
              item 7 go started with a single question, why should fast food
              mean low quality? We set out to answer that question on Iwo Road,
              and we have been answering it every day since.
            </motion.p>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex flex-col gap-5 text-sm text-brand-muted leading-relaxed">
              ...
              <p>
                ...
                something. Customers kept returning, not just for the shawarma
                or the jollof rice, but for the experience of being served well
                at a price that made sense.
              </p>
              <p>
                Today, item 7 go is one of Ibadan's most recognised fast casual
                brands. We have expanded our menu, refined our service, and
                stayed true to the one thing that started it all, making food
